  ...
  const projects: ProjectType[] = [
    {
      ...
      description:
        'A comprehensive accounting system designed to streamline financial operations and provide real-time monitoring of accounting processes.',
    ...
    },
    {
      ...
      description:
        'A mobile application designed to address limited access, cultural stigma, and privacy concerns surrounding family planning and reproductive health. Contributed to the development, while the primary developer of the project is Jemimah Indoken',
    ...
    },
    {
      ...
      features: ['Itinerary Generator', 'Parking Area Location', 'Tourist spot Information','Statistic Report'],
      category: 'web',
      github: '',
      demo: null,
    },
